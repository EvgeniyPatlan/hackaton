...
exports.LocationsModule = LocationsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [locations_service_1.LocationsService, locations_repository_1.LocationsRepository, locations_search_service_1.LocationsSearchService],
        exports: [locations_service_1.LocationsService, locations_repository_1.LocationsRepository, locations_search_service_1.LocationsSearchService],
    })
], LocationsModule);
